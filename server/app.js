...
app.post("/markAttendance", async (req, res) => {
  ...
  const classroomLatitude = 21.253970; // Replace with the actual latitude of the classroom
  const classroomLongitude = 81.601928; // Replace with the actual longitude of the classroom
  ...
  try {
    ...
    if (!user) {
      ...
      const thresholdDistance = 50; // Adjust this value based on your needs
